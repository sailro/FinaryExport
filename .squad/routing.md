...
|-----------|----------|----------|
| Architecture & design | Rusty | System structure, API design, project layout, decisions |
| .NET implementation | Linus | C# code, data models, API client, xlsx export, project config |
