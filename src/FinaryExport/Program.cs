...
var periodOption = new Option<string?>("--period") { Description = "Time period filter (1d, 1w, 1m, 3m, 6m, 1y, ytd, all)" };
...
static void ConfigureHost(HostApplicationBuilder builder, string? output, string? period = null, bool clearSession = false)
{
